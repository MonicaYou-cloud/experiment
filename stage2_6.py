...
participants = {
    ...
    "TyTp26": [datetime(2025, 9, 13, 20, 30, 0, tzinfo=tz), datetime(2025, 9, 15, 21, 30, 0, tzinfo=tz)],
    "JPMJ26": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2025, 9, 16, 11, 0, 0, tzinfo=tz)],
    "Cnof26": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2025, 9, 16, 14, 30, 0, tzinfo=tz)],
    "Lcfq26": [datetime(2025, 9, 15, 14, 0, 0, tzinfo=tz), datetime(2025, 9, 15, 15, 0, 0, tzinfo=tz)],
    "VziE26": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2025, 9, 16, 11, 0, 0, tzinfo=tz)],
    "aALM26": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2025, 9, 16, 14, 30, 0, tzinfo=tz)],
    "gufs26": [datetime(2025, 9, 15, 14, 0, 0, tzinfo=tz), datetime(2025, 9, 15, 15, 0, 0, tzinfo=tz)],
    "ndZb26": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2025, 9, 16, 11, 0, 0, tzinfo=tz)],
    "rDed26": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2025, 9, 16, 14, 30, 0, tzinfo=tz)],
    "xmQA26": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2025, 9, 16, 14, 30, 0, tzinfo=tz)],
}
