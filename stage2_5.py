...
@st.cache_resource
def get_sheet():
    return client.open("experiment_data").worksheet("stage2-5")
...
participants = {
    ...
    "EYGT25": [datetime(2025, 9, 13, 20, 30, 0, tzinfo=tz), datetime(2026, 9, 15, 21, 30, 0, tzinfo=tz)],
    "JurM25": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2026, 9, 16, 11, 0, 0, tzinfo=tz)],
    "OetM25": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2026, 9, 16, 14, 30, 0, tzinfo=tz)],
    "RaYx25": [datetime(2025, 9, 15, 14, 0, 0, tzinfo=tz), datetime(2026, 9, 15, 15, 0, 0, tzinfo=tz)],
    "ZYrQ25": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2026, 9, 16, 11, 0, 0, tzinfo=tz)],
    "dFsQ25": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2026, 9, 16, 14, 30, 0, tzinfo=tz)],
    "gdFs25": [datetime(2025, 9, 15, 14, 0, 0, tzinfo=tz), datetime(2026, 9, 15, 15, 0, 0, tzinfo=tz)],
    "pXby25": [datetime(2025, 9, 16, 10, 0, 0, tzinfo=tz), datetime(2026, 9, 16, 11, 0, 0, tzinfo=tz)],
    "qfVw25": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2026, 9, 16, 14, 30, 0, tzinfo=tz)],
    "wqyA25": [datetime(2025, 9, 16, 13, 30, 0, tzinfo=tz), datetime(2026, 9, 16, 14, 30, 0, tzinfo=tz)],
}
