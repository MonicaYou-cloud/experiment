...
# 基本資料頁
    ...
    self-esteem1 = st.radio("", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem1")
    self-esteem2 = st.radio("", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem2")
    self-esteem3 = st.radio("", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem3")
    self-esteem4 = st.radio("", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem4")
    self-esteem5 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem5")
    self-esteem6 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem6")
    self-esteem7 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem7")
    self-esteem8 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem8")
    self-esteem9 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem9")
    self-esteem10 = st.radio("請選擇您的性別", ["非常不同意", "不同意", "有點不同意", "有點同意", "同意", "非常同意"], index=None, key="self-esteem10")
    st.markdown("---")
